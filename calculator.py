...
# THIS CODE IS MADE BY SANUJ KUMAR SINGH,VAIBHAV PRATAP SINGH AND MAYANK ARYAN
...
def Welcome():
    ...
    print("|\n| MADE BY:  ", " SANUJ KUMAR SINGH (0105CS191109) \t\t|", end="\n")
    print("|\n| \t     VAIBHAV PRATAP SINGH (0105CS191123) \t\t|",end="\n\n")
    print("|\n| \t       AND  \t\t\t \t\t|")
    print("|\n| \t    MAYANK ARYAN (0105CS191123) \t\t|",end="\n\n")
